...
![](/assets/images/posts/dns/dns-1.png)
...
![](/assets/images/posts/dns/dns-2.png)

1. 客户端首先会发出一个 DNS 请求，问 www.server.com 的 IP 是多少，并发给本地 DNS 服务器（也就是客户端的 TCP/IP 设置中填写的 DNS 服务器地址）。
