...
如上图所示，当收到发送节点的节点槽信息以后，接受节点会将这些信息保存到本地的 clusterState 的结构中，其中 Slots 的数组就是存放每个槽对应哪些节点信息。
...
![](/assets/images/posts/redis-cluster/redis-cluster-9.png)
...
![](/assets/images/posts/redis-cluster/redis-cluster-10.png)
