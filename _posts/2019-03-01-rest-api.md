...
如果API服务需要实现安全认证功能，建议使用[JWT]实现。

# 日期显示
日期格式建议使用Unix时间戳实现，如果需要输出特定格式的日期格式，建议采用[ISO_8601]建议的格式
...
[version]: http://stackoverflow.com/questions/389169/best-practices-for-api-versioning
